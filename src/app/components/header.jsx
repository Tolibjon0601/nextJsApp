	...
	return (
      ...
      <img src="/image/header-logo.svg" alt="Logo" />
			...
			<ul className="flex gap-2 ">
				...
				<li>
					<Link className="hover:bg-blue px-2 py-2 rounded-lg hover:text-white" href="/xizmatlar">
						Xizmatlar
					</Link>
				</li>
				<li>
					<Link className="hover:bg-blue px-2 py-2 rounded-lg hover:text-white" href="/portfolio">
						Portfolio
					</Link>
				</li>
				<li>
				...
				<li>
					<a className="hover:bg-blue px-2 py- rounded-lg hover:text-white" href="">
						Blog
					</a>
				</li>
				<li>
					<a className="hover:bg-blue px-2 py-1 rounded-lg hover:text-white" href="">
						Kontaktlar
					</a>
				</li>
				<li>
